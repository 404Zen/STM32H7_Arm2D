...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
// __attribute__((section(".EXT_FLASH"))) uint8_t ext_flash_data[] = {8,7,6,5,4,3,2,1};
// uint8_t my_variable[8] __attribute__((section(".EXT_FLASH"))) = {1,2,3,4,5,6,7,8};
/* USER CODE END 0 */
...
int main(void)
{
  ...
  uint32_t ext_flash_id = 0;
  uint32_t ext_flash_mapped_ok = 0;
